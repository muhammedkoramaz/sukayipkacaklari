...
u("/blog/", "monthly", "0.8")
for _rs in ("su-kacagi-nasil-anlasilir", "debi-olcumu-nedir", "basinc-yonetimi-nedir", "akustik-su-kacagi-tespiti-nedir", "dma-nedir", "adim-testi-nedir", "su-kaybi-dusurme-yol-haritasi"):
